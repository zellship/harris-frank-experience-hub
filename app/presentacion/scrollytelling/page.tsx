...
const chapters = [
  ...
  ["inversion", "Inversión"], ["decision", "Activar Fase 1"],
  ...
  return (
    <main ref={shellRef} className="story-shell">
      ...
      <section id="equipo" className="story-chapter chapter-team">
        ...
        <div className="cadence-line"><span><i />Semanal<strong>avance y bloqueos</strong></span><span><i />Mensual<strong>valor y decisiones</strong></span><span><i />Trimestral<strong>wave y aceptación</strong></span><span><i />Anual<strong>evolución del portafolio</strong></span></div>
      </section>
      ...
      <section id="valor" className="story-chapter chapter-value light-chapter">
        <div className="story-content value-copy"><span className="story-kicker">Valor desde el primer trimestre</span><h2>No hay que esperar al cierre<em>para recibir valor utilizable.</em></h2><p>El primer ciclo debe dejar una base que pueda verse, probarse y decidirse.</p></div>
      ...
      <section id="inversion" className="story-chapter chapter-investment">
        <div className="story-content investment-copy"><span className="story-kicker">Programa anual de evolución operativa</span><h2>La inversión compra<em>capacidad continua de evolución.</em></h2><p>No sólo una aplicación: modelo, diseño, desarrollo, implementación, soporte, asistencia y mejora dentro de un mismo programa.</p><div className="investment-includes"><span>Modelo operativo</span><span>Equipo extendido</span><span>Implementación</span><span>Gobierno</span><span>Mejora continua</span></div></div>
        <article className="investment-card"><small>Base comercial · versión v4.0</small><div><span>Programa anual</span><strong>$850,000</strong><i>MXN + IVA</i></div><div className="credit"><span>Crédito aplicado</span><strong>−$55,900</strong></div><div className="investment-total"><span>Nueva inversión</span><strong>$794,100</strong><i>12 mensualidades de $66,175</i></div><footer>Borrador sujeto a alcance, anexos y aceptación comercial final.</footer></article>
      </section>
      ...
      <section id="decision" className="story-chapter chapter-close">
        ...
        <div className="story-content close-copy"><span className="story-kicker">La decisión</span><h2>Proteger lo extraordinario.<em>Hacerlo ejecutable. Evolucionarlo juntos.</em></h2><p>La Fase 1 activa un primer ciclo controlado para convertir entendimiento en capacidad utilizable, evidencia y una siguiente decisión segura.</p><div className="decision-steps"><span><i>01</i>Aprobar el programa</span><span><i>02</i>Cerrar anexos y alcance</span><span><i>03</i>Activar el primer ciclo</span></div><div className="close-actions"><Link className="primary" href="/demo">Recorrer la Demo <span>↗</span></Link><Link href="/propuesta">Explorar la propuesta</Link><Link href="/">Volver al Hub</Link></div><small className="prototype-note">Narrativa consolidada de las versiones 1–4 · términos comerciales sujetos a revisión final.</small></div>
      </section>
